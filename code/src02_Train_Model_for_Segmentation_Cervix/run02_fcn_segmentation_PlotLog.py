...
if __name__ == '__main__':
    ...
    # pathModelValLoss = '{0}/model_fcn_cervix_v1.h5'.format(wdir)
    # pathModelValAcc = '{0}/model_fcn_cervix_val_v1.h5'.format(wdir)
    # pathModelLatest = '{0}/model_fcn_cervix_acc_v1.h5'.format(wdir)
    ...
    # pathLog = '%s-log.csv' % pathModelValLoss
    #
    pathModelPrefix = '{0}/model_fcn_cervix_EXT1'.format(wdir)
