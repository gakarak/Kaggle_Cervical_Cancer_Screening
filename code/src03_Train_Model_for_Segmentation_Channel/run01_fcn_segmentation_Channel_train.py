...
if __name__ == '__main__':
    ...
    fidxVal = '/home/ar/@Kaggle/01_Intel_&_MobileODT_Cervical_Cancer_Screening/data_additional/01_train_add-x512-original-bordered_Results/idx.txt-val.txt'
    ...
    # dataTrn = dataVal
    print ('-')
    # valX, valY = next(train_generator_CHANNEL(dataImg=dataVal,
